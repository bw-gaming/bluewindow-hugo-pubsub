...
class HugoRunner:
    ...
    def notify(self, payload, update):
        ...
        notification = self.publisher.publish(self.notification_topic_path, data)
    ...
    def callback(self, message):
        ...
        self.notify(payload, {'output'  : result, 'status' : 'succeded' if result.returncode == 0 else 'failed' })
...
if __name__ == "__main__":
    ...
    runner = HugoRunner(project_id, subscription_id, notify_topic_name, bucket_in, bucket_out, publish_script)
